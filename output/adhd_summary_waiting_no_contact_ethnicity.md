# ADHD Summary: Waiting with No Contact by Ethnicity

**Dataset:** `adhd_summary_waiting_no_contact_ethnicity`
...
**Type:** integer  
**Description:** Number of individuals of African ethnicity waiting for an ADHD assessment with no contact.  
**Search Terms:** african, ethnicity, waiting, no contact, assessment, count  
**Metadata Quality:** ~ llm (confidence: 0.70)  
