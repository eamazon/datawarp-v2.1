# Publication Summary Table 2B

**Dataset:** `publication_summary_table_2b`
**Domain:** Unknown
**Rows:** 30
**Columns:** 11
...
#### `date_appointment_date`

**Type:** character varying  
**Description:** System column  
**Metadata Quality:** ✓ system (confidence: 1.00)  

#### `total_count_of_appointments3_total_number_of_appointments`
