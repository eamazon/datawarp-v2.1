# ADHD Prevalence (Recorded)

**Dataset:** `adhd_prevalence_recorded`
...
- **Date Range:** ADHD_recorded_prevalence to ADHD_recorded_prevalence
- **Rows in Export:** 162
...
**Description:** The measure being reported (e.g., ADHD recorded prevalence).  
...
**Type:** numeric  
**Description:** The percentage of patients with recorded ADHD prevalence.  
