# ADHD Medication Prescribing (Without ADHD Diagnosis)

**Dataset:** `adhd_medication_without_diagnosis`
...
- **Date Range:** ADHD_medication_without_ADHD_diagnosis to ADHD_medication_without_ADHD_diagnosis
- **Rows in Export:** 162
...
**Description:** The measure being reported (e.g., ADHD medication without ADHD diagnosis).  
...
**Search Terms:** denominator, total, population  
**Metadata Quality:** ~ llm (confidence: 0.70)  
...
**Type:** numeric  
**Description:** The percentage of patients prescribed ADHD medication without a diagnosis.  
**Search Terms:** percentage, rate, proportion  
**Metadata Quality:** ~ llm (confidence: 0.70)  
