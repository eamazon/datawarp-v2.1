# ADHD Summary: Waiting for First Contact by Gender

**Dataset:** `adhd_summary_waiting_first_contact_gender`
...
**Type:** integer  
**Description:** Number of males waiting for an ADHD assessment with first contact.  
**Search Terms:** male, waiting, first contact, assessment, count  
**Metadata Quality:** ~ llm (confidence: 0.70)  
