# Appointments Gp Coverage

**Dataset:** `appointments_gp_coverage`
**Domain:** Unknown
**Rows:** 9,540
**Columns:** 12
...
- **Date Range:** 00L to X2C4Y
- **Rows in Export:** 9,540
...
#### `patients_registered_at_included_practices`
