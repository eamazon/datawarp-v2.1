# ADHD Summary: Waiting for Assessment by Gender

**Dataset:** `adhd_summary_waiting_assessment_gender`
...
**Type:** integer  
**Description:** Number of males waiting for an ADHD assessment.  
**Search Terms:** male, waiting, assessment, count  
**Metadata Quality:** ~ llm (confidence: 0.70)  
