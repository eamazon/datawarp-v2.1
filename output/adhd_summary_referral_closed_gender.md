# ADHD Summary: Referral Closed by Gender

**Dataset:** `adhd_summary_referral_closed_gender`
...
**Type:** integer  
**Description:** Number of males whose ADHD assessment referral was closed.  
**Search Terms:** male, referral closed, assessment, count  
**Metadata Quality:** ~ llm (confidence: 0.70)  
