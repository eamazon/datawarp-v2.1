# General Practice Submissions: Day and Time

**Dataset:** `gp_submissions_day_time`
**Domain:** Unknown
**Rows:** 168,265
**Columns:** 19
...
**Search Terms:** ICB code, board code  
**Metadata Quality:** ~ llm (confidence: 0.70)  
...
**Search Terms:** ICB name, board name  
**Metadata Quality:** ~ llm (confidence: 0.70)  
...
**Search Terms:** PCN code, network code  
**Metadata Quality:** ~ llm (confidence: 0.70)  
...
**Search Terms:** PCN name, network name  
**Metadata Quality:** ~ llm (confidence: 0.70)  
...
**Search Terms:** supplier, provider  
**Metadata Quality:** ~ llm (confidence: 0.70)  
...
**Type:** character varying  
**Description:** The time range of the submission.  
**Search Terms:** submission time, time range  
**Metadata Quality:** ~ llm (confidence: 0.70)  
