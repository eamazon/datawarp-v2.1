# ADHD Summary: New Referrals by Gender

**Dataset:** `adhd_summary_new_referrals_gender`
...
**Type:** integer  
**Description:** Number of males newly referred for an ADHD assessment.  
**Search Terms:** male, new referrals, assessment, count  
**Metadata Quality:** ~ llm (confidence: 0.70)  
